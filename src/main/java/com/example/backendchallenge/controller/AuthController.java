...
@PostMapping("/register")
    public RegisterResponse register(@RequestBody RegisterUser registerUser){
        ApplicationUser createdUser = authenticationService.register(registerUser.fullName(), registerUser.email(), registerUser.password());
       return new RegisterResponse(createdUser.getFullName(), "kayıt başarılı bir şekilde gerçekleşti.");
    }
}
